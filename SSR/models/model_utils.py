...
def raw2outputs(raw, z_vals, rays_d, raw_noise_std=0, white_bkgd=False, enable_semantic=True, 
    ...
    if enable_semantic:
        ...
        sem_logits = raw[..., 11:11+num_sem_class]  # [N_rays, N_samples, num_class]
    ...
    return rgb_map, disp_map, acc_map, weights, depth_map, sem_map, feat_map, albedo_map, shading_map, residual_map
